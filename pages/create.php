        ...
        <form method="POST" autocomplete="off">
            <div class="container my-5">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" placeholder="Insira a descrição da notícia" name="description" style="height: 10rem; resize: none;" required></textarea>
                </div>
                <div class="mb-3">
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `noticia`(nomeNoticia, descricaoNoticia, urgenteNoticia, dataNoticia) VALUES('$name', '$desc', '$urgent', '$date')";
